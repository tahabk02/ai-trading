...
export default function SettingsPage() {
  ...
  const tfOptions = [
    { value: "1s", label: "1s" },
    { value: "5s", label: "5s" },
    { value: "20s", label: "M20 (20s)" },
    { value: "1m", label: `1m (${t("scalping")})` },
    { value: "2m", label: `2m (${t("scalping")})` },
    { value: "3m", label: `3m (${t("scalping")})` },
    { value: "5m", label: `5m (${t("scalping")})` },
    { value: "10m", label: `10m (${t("scalping")})` },
    { value: "15m", label: `15m (${t("intraday")})` },
    { value: "20m", label: `20m (${t("intraday")})` },
    { value: "25m", label: `25m (${t("intraday")})` },
    { value: "30m", label: `30m (${t("intraday")})` },
    { value: "35m+", label: `35m+ (${t("extended")})` },
    { value: "1h", label: `1H (${t("hourly")})` },
    { value: "4h", label: `4H (${t("swing")})` },
    { value: "1d", label: `1D (${t("daily")})` },
    { value: "2d", label: `2D (${t("multiDay")})` },
    { value: "3d", label: `3D (${t("multiDay")})` },
    { value: "5d", label: `5D (${t("weekly")})` },
    { value: "10d", label: `10D (${t("biWeekly")})` },
  ];
